...
export const personalData = {
  ...
  description:
    "My name is , and I am a passionate and dedicated programmer with a strong drive for learning and exploring new technologies. I am a quick learner with a self-motivated approach, always eager to solve challenging problems and create impactful solutions.",
  description2:
  ...
  resume:
    "https://drive.google.com/file/d/1qHTjg-Srhodfv5Nt0hPfZmVAnVx193U7/view?usp=sharing",
};
```
